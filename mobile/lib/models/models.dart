...
class AgentSession {
  ...
  String statusFailureReason(int maxLength) =>
      _truncateText(statusReasonText, maxLength);

  int remainingRateLimitResetMs({DateTime? now}) {
  ...
  String rateLimitCountdownLabel({DateTime? now}) {
  ...
  factory AgentSession.fromJson(Map<String, dynamic> json) {
    ...
    final parsedStatusReason = _firstModelString(json, [
      'statusReason',
      'failureReason',
      'reason',
    ]);
