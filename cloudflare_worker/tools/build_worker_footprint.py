...
# The chart draws proportions, not an audit log: keep the committed snapshot
# until the drawing would actually move by this fraction of its own scale.
REFRESH_DRIFT_RATIO = 0.02
# Totals compared against the committed snapshot before refreshing it.
TRACKED_TOTALS = (
    "attachedPythonBytes",
...
def needs_refresh(data=None):
    ...
    try:
        ...
        # An asset written by an older generator: rebuild it outright.
        return True
