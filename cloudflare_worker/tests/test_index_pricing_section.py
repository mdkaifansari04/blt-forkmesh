...
def test_pricing_section_uses_network_participation_copy():
    ...
    for text in (
        ...
        "Participation <strong>does not require a contribution</strong>",
        "Join or fund the reward program",
        "Non-custodial: ForkMesh never stores community members’ wallet private",
        "Community incentives are not investments",
    ):
