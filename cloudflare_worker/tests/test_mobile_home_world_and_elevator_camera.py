...
def test_elevator_uses_upper_corner_first_person_framing_and_restores_view():
    ...
    assert "new THREE.Vector3(-3.72, 6.46, -2.72)" in SCENE
    assert "new THREE.Vector3(0.85, 3.15, -11.5)" in SCENE
    assert "elevatorPanel.position.set(2.0, 3.3, -3.25)" in SCENE
