...
export const LANDMARKS = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Fresh health, integrity, authorization, and abuse state are evaluated independently.",
  ...
  },
  {
    ...
    shortLabel: "Trust station",
    eyebrow: "ABUSE RESPONSE / 08",
    icon: "◇",
    color: "#ff8e78",
    position: [16, 0, -14],
    summary: "A restrained administrative view of rate limits, temporary quarantines, and appeals.",
    metaphor: "A distant station contains hostile clients without turning enforcement into spectacle.",
    reality:
      "Public views use generalized reasons and incident tokens, never raw IPs. Detailed evidence is private and retained only as long as policy requires.",
    status: "Administrative concept",
    statusTone: "prototype",
    bullets: [
      "One uncertain signal does not create a permanent ban.",
      "Shared networks, VPNs, proxies, and carrier NAT are considered.",
      "Country, browser, and operating system are never evidence of abuse.",
      "Every restriction can carry review and appeal state.",
    ],
    primary: { label: "Review safeguards", action: "quarantine" },
  ...
  },
  {
    ...
    shortLabel: "Support",
    eyebrow: "PROJECT SUSTAINABILITY / 14",
    icon: "♥",
    color: "#ffd08f",
    position: [-15, 0, 20],
