...
class ForkMeshWorldNotes extends HTMLElement {
  ...
  connectedCallback() {
    ...
    $(".open").onclick = () => { $(".open").classList.add("hidden"); $(".panel").classList.add("on"); void this.load(); };
    $("[data-close]").onclick = () => { $(".panel").classList.remove("on"); $(".open").classList.remove("hidden"); };
