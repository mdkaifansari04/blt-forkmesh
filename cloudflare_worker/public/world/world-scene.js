...
const WORLD_TASK_BULLETIN_ITEMS = Object.freeze([
  ...
  { task: "Add real PR section tabs", done: true },
  { task: "Put changed PR files in a left list", done: true },
  { task: "Persist each file's viewed state", done: true },
  { task: "Let reviewers approve PRs", done: true },
  { task: "Merge exact reviewed commits into a mirror", done: true },
  { task: "Sync mirror merges to the source of truth", done: true },
  { task: "Keep mirror merge owner-only for now", done: true },
  { task: "Add PR authorization and UI tests", done: true },
  { task: "Let admins group offline users", done: true },
  { task: "Put group controls on seated users' backs", done: true },
  { task: "Integrate the remaining session branches", done: true },
  { task: "Delete merged session branches and worktrees", done: true },
  { task: "Restore the preserved user test changes", done: true },
