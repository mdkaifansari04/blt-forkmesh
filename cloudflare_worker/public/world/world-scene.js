...
const WORLD_TASK_BULLETIN_ITEMS = Object.freeze([
  ...
  { key: "done:qa-history-detail", task: "QA history opens full verdict cards", estimate: "ready", done: true },
  { key: "done:elevator-front-camera", task: "Elevator front camera + clear controls", estimate: "ready", done: true },
  { key: "done:office-only-hours", task: "Office-only Marketing attendance", estimate: "ready", done: true },
  { key: "done:marketing-furniture", task: "Window desks + visible table chairs", estimate: "ready", done: true },
  { key: "done:office-landscaping", task: "Trees, bushes + flowers around Office", estimate: "ready", done: true },
