...
SCENE = (ROOT / "world/public/world/world-scene.js").read_text()
APP = (ROOT / "world/public/world/world.js").read_text()
HTML = (ROOT / "world/public/world/index.html").read_text()
ENTRY = (ROOT / "app/src/entry.py").read_text()
