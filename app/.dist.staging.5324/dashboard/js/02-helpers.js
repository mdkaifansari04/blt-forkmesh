  ...
  // The profile picture is stored inside the encrypted account record rather
  // than as an attachment, so its budget is its own and much tighter than a
  // repository image's.
  const PROFILE_AVATAR_MAX_BYTES = 256 * 1024;
  const PROFILE_AVATAR_RAW_MAX_BYTES = 20 * 1024 * 1024;
