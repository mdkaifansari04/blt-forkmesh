...
checkout. The desktop installer (`desktop/install.sh`), the public release
...
Use `server/packaging/systemd/mirror-node.json.example` as the configuration template.
