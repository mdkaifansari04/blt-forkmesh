...
// RegisterNodeAccount performs the same free key-bound registration used by
// the former headless Qt process.  The six-digit installer code lets the
// provisioning desktop attach the new node to its signed-in owner account.
