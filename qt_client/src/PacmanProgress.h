...
// sticky bar pins a copy of it (adhoc #423). Both surfaces rasterise this one
                                ...
                                const QColor &color)
{
    ...
    // Pac-Man body: a pie sweeping `progress` of the full turn, centred so its
    // mouth (the unfilled remainder) opens to the right (3 o'clock). Qt pie
    // angles are 1/16-degree, 0 at 3 o'clock, counter-clockwise.
